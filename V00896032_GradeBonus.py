...
# Apart from this i am trying to learn elastic regularization which is sort of combination of L1 and L2 regularization
#it choses different ratios of L1 and l2 parameters. I will continue working on this topic once i get time in future.
